...
public class ParkParser {
    ...
    public static List<ParkDTO> retrieveParks (String jsonString){
        String url = null;
        int urlCount = 0;
        ...
        for (String chunk: split) {
            ...
            switch(values[0]) {
                ...
                case "designation":
                    ...
                    ParkDTO temp = new ParkDTO(url, fullName, code, latitude, longitude, latLong, activities, topics, states, directionsInfo, directionsUrl, name, designation);
...
//			System.out.println("----------------");
                    ...
                    //reset all local variables to null
